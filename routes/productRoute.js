...
const { getAllProducts, getProductById, createProduct, getProductsByCategory, getFilterBycategory, updateProduct, deleteProduct} = require('../controllers/productcontroller');
